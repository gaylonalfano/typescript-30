...
var team2 = players.slice(); // Returns a copy, so won't update players as well
// one way
// or create a new array and concat the old one in
// Returns a copy (has its own unique reference in memory), so won't update players as well
var team3 = [].concat(players); // Returns a copy (has its own unique reference in memory), so won't update players as well
// or use the new ES6 Spread
// Returns a copy (has its own unique reference in memory), so won't update players as well
var team4 = __spreadArrays(players); // Returns a copy, so won't update players as well
...
var captain2 = Object.assign({}, person, { age: 99 });
...
var adrian = Object.assign({}, gaylon);
...
var aaron = JSON.parse(JSON.stringify(gaylon));
